...
import 'src/utils/platform.dart' if (dart.library.html) 'utils/platform_web.dart';
...
class DragAndDrop extends StatefulWidget {
  ...
  @override
  State<DragAndDrop> createState() => _DropTargetState();
}
...
class _DropTargetState extends State<DragAndDrop> {
  ...
  @override
  void didUpdateWidget(DragAndDrop oldWidget) {
